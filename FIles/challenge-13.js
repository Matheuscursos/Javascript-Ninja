...
var mostrar = arr.toString();
console.log( 'O array em formato de string é:'  + mostrar);
...
var sudeste = ["Sao paulo", "Espirito Santo", "Minas Gerais", "Rio de Janeiro"];
...
var sete = brasil.every(function(item){
